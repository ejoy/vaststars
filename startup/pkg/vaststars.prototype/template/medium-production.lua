...
local entities = { {
  ...
  dir = "N",
  items = { { "铁矿石", 59 }, { "铝矿石", 60 }, { "铁板", 30 }, { "碎石", 1 } },
  prototype_name = "仓库I",
  x = 121,
  y = 133
}, {
  ...
  dir = "N",
  items = { { "碎石", 3 }, { "铁矿石", 4 }, { "铝矿石", 4 }, { "地质科技包", 0 } },
  prototype_name = "组装机I",
  recipe = "地质科技包1",
  x = 122,
  y = 130
  ...
  dir = "N",
  items = { { "电动机I", 2 }, { "铁齿轮", 6 }, { "机械科技包", 0 }, { "石砖", 0 }, { "管道1-X型", 10 } },
  prototype_name = "组装机I",
  recipe = "机械科技包T1",
  x = 122,
  y = 135
  ...
  dir = "N",
  items = { { "地质科技包", 2 }, { "气候科技包", 2 }, { "机械科技包", 2 }, { "电子科技包", 1 }, { "化学科技包", 2 }, { "物理科技包", 0 } },
  ...
  dir = "N",
  items = { { "地质科技包", 2 }, { "气候科技包", 1 }, { "机械科技包", 2 }, { "电子科技包", 1 }, { "化学科技包", 2 }, { "物理科技包", 0 } },
  prototype_name = "科研中心I",
  x = 125,
  y = 130
}, {
  ...
  dir = "N",
  items = { { "管道1-X型", 60 }, { "气候科技包", 29 }, { "地下管1-JI型", 1 }, { "液罐I", 1 } },
  prototype_name = "仓库I",
  x = 125,
  y = 136
}, {
  ...
  items = { { "空气", 3899 }, { "地下卤水", 4000 }, { "气候科技包", 2 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 131
  ...
  items = { { "二氧化碳", 64 }, { "氢气", 220 }, { "甲烷", 0 }, { "纯水", 15 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 152
  ...
  dir = "N",
  items = { { "碾碎铁矿石", 1 }, { "石墨", 2 }, { "铁板", 6 }, { "碎石", 0 }, { "铁矿石", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "铁板2",
  x = 111,
  y = 130
  ...
  dir = "N",
  items = { { "沙子", 0 }, { "沙子", 0 }, { "碾碎铝矿石", 48 }, { "碾碎铝矿石", 49 } },
  prototype_name = "仓库I",
  x = 121,
  y = 148
}, {
  ...
  items = { { "二氧化碳", 80 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 11 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  items = { { "二氧化碳", 80 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 14 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 169
  ...
  dir = "N",
  items = { { "铁矿石", 60 }, { "铁矿石", 60 }, { "石墨", 22 }, { "石墨", 22 } },
  prototype_name = "仓库I",
  x = 91,
  y = 170
}, {
  ...
  dir = "N",
  items = { { "铝矿石", 3 }, { "碾碎铝矿石", 3 }, { "碾碎铁矿石", 1 }, { "沙子", 0 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 150
  ...
  dir = "N",
  items = { { "硅板", 25 }, { "硅板", 26 }, { "石墨", 30 }, { "逻辑电路", 15 } },
  prototype_name = "仓库I",
  x = 123,
  y = 166
}, {
  ...
  items = { { "二氧化碳", 64 }, { "氢气", 220 }, { "甲烷", 0 }, { "纯水", 11 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 156
  ...
  items = { { "铝丝", 6 }, { "硅板", 8 }, { "润滑油", 10 }, { "逻辑电路", 3 }, { "电子科技包", 0 }, { "电容I", 0 }, { "绝缘线", 0 } },
  prototype_name = "组装机I",
  recipe = "逻辑电路1",
  x = 128,
  y = 164
  ...
  dir = "S",
  items = { { "demand", "铝矿石", 2 }, { "supply", "碾碎铝矿石", 2 }, { "demand", "碎石", 2 }, { "supply", "沙子", 2 } },
  prototype_name = "物流站",
  x = 116,
  y = 146
}, {
  ...
  items = { { "二氧化碳", 64 }, { "氢气", 131 }, { "甲烷", 0 }, { "纯水", 14 } },
  ...
  items = { { "二氧化碳", 64 }, { "氢气", 195 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 63,
  y = 154
  ...
  items = { { "氯气", 160 }, { "石墨", 1 }, { "金红石", 5 }, { "四氯化钛", 0 }, { "废料", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "四氯化钛",
  x = 99,
  y = 133
  ...
  items = { { "氯气", 160 }, { "石墨", 0 }, { "金红石", 5 }, { "四氯化钛", 0 }, { "废料", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "四氯化钛",
  x = 99,
  y = 140
  ...
  items = { { "氦气", 2 }, { "钠", 3 }, { "四氯化钛", 7 }, { "钛板", 1 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "钛板",
  x = 103,
  y = 115
  ...
  items = { { "氦气", 2 }, { "钠", 11 }, { "四氯化钛", 0 }, { "钛板", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "钛板",
  x = 109,
  y = 115
