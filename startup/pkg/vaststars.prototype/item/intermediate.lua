...
prototype "碎石" {
    ...
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_stone.texture",
...
prototype "铁矿石" {
    ...
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_iron.texture",
...
prototype "铝矿石" {
    ...
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_aluminium.texture",
