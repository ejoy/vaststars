...
M.MAX_BUILDING_WIDTH_COUNT = 6
M.MAX_BUILDING_HEIGHT_COUNT = 6
M.MAX_BUILDING_WIDTH_SIZE = M.MAX_BUILDING_WIDTH_COUNT * M.TILE_SIZE
M.MAX_BUILDING_HEIGHT_SIZE = M.MAX_BUILDING_HEIGHT_COUNT * M.TILE_SIZE
