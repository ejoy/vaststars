...
local function _package_files(root)
    ...
    local skip_ext = {
        ...
        "^/pkg/ant.resources/materials/postprocess/dof/downsample.material$",
        "^/pkg/ant.resources/materials/postprocess/dof/resolve.material$",
        ...
        "^/pkg/ant.resources/materials/postprocess/dof/.*$", -- TODO
