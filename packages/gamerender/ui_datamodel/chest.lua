...
function M:stage_ui_update(datamodel)
    ...
    for _, _, _, chest_object_id, prototype, count in to_chest_mb:unpack() do
        ...
        if pickup_count > 0 then
            iworld.base_chest_pickup_place(gameplay_core.get_world(), chest_e.chest.chest_in, prototype, pickup_count, true)
        end
        self:flush()
        ::continue::
    end
    ...
    for _, _, _, chest_object_id, prototype, count in to_headquater_mb:unpack() do
        ...
        iworld.base_chest_pickup_place(gameplay_core.get_world(), chest_e.chest.chest_in, prototype, count, false)
        self:flush()
        ::continue::
    end
