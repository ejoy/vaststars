...
local function writeEntityH(components)
    ...
    write "} \\"
    write "template <> constexpr inline int ecs_api::component_id<vaststars::component::NAME> = __COUNTER__ - _component_start_id_;"
    write ""
    ...
    write "static_assert(ecs_api::component_id<component::eid> == ecs_api::COMPONENT::EID);"
    write ""
