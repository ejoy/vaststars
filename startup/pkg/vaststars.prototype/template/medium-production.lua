...
local entities = { {
  ...
  dir = "N",
  items = { { "铁矿石", 60 }, { "铝矿石", 60 }, { "碎石", 58 }, { "铁板", 15 } },
  prototype_name = "仓库I",
  x = 121,
  y = 133
}, {
  ...
  dir = "N",
  items = { { "地质科技包", 2 }, { "气候科技包", 2 }, { "机械科技包", 2 }, { "电子科技包", 0 }, { "化学科技包", 2 }, { "物理科技包", 0 } },
  prototype_name = "科研中心I",
  x = 125,
  y = 133
}, {
  dir = "N",
  items = { { "石砖", 26 }, { "机械科技包", 30 }, { "地质科技包", 30 }, { "铁棒", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 134
}, {
  ...
  items = { { "二氧化碳", 64 }, { "氢气", 129 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 152
  ...
  dir = "N",
  items = { { "铁齿轮", 30 }, { "铁齿轮", 30 }, { "电动机I", 14 }, { "采矿机I", 15 } },
  prototype_name = "仓库I",
  x = 121,
  y = 137
}, {
  ...
  dir = "N",
  items = { { "碾碎铝矿石", 60 }, { "碾碎铝矿石", 60 }, { "沙子", 1 }, { "沙子", 1 } },
  prototype_name = "仓库I",
  x = 121,
  y = 148
}, {
  ...
  items = { { "二氧化碳", 40 }, { "氢气", 0 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  items = { { "二氧化碳", 80 }, { "氢气", 29 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 169
  ...
  items = { { "碾碎铝矿石", 5 }, { "碱性溶液", 57 }, { "氢氧化铝", 5 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 152,
  y = 167
  ...
  items = { { "碳化铝", 3 }, { "纯水", 120 }, { "氢氧化铝", 0 }, { "甲烷", 0 } },
  prototype_name = "化工厂I",
  recipe = "氢氧化铝",
  x = 157,
  y = 172
  ...
  dir = "N",
  items = { { "石墨", 2 }, { "氧化铝", 2 }, { "塑料", 6 }, { "铝板", 0 }, { "电容I", 0 } },
  prototype_name = "组装机I",
  recipe = "电容1",
  x = 169,
  y = 166
  ...
  dir = "N",
  items = { { "电子科技包", 0 }, { "化学科技包", 30 }, { "物理科技包", 0 } },
  prototype_name = "仓库I",
  x = 121,
  y = 135
}, {
  ...
  dir = "S",
  items = { { "demand", "铝矿石", 2 }, { "supply", "碾碎铝矿石", 1 }, { "demand", "碎石", 2 }, { "demand", "沙子", 3 } },
  prototype_name = "物流站",
  x = 116,
  y = 146
}, {
  ...
  dir = "N",
  items = { { "电容I", 2 }, { "绝缘线", 2 }, { "逻辑电路", 2 }, { "电子科技包", 0 } },
  prototype_name = "组装机I",
  recipe = "电子科技包1",
  x = 130,
  y = 167
  ...
  items = { { "地下卤水", 90 }, { "氧气", 0 }, { "氢气", 127 }, { "氯气", 0 } },
  prototype_name = "电解厂I",
  recipe = "地下卤水电解1",
  x = 73,
  y = 137
  ...
  dir = "N",
  items = { { "玻璃", 16 }, { "铝棒", 1 }, { "无人机平台II", 8 }, { "科研中心I", 0 } },
  prototype_name = "组装机I",
  recipe = "科研中心1",
  x = 174,
  y = 168
  ...
  dir = "N",
  items = { { "铝棒", 4 }, { "钢齿轮", 1 }, { "无人机平台I", 2 }, { "无人机平台II", 0 } },
  prototype_name = "组装机I",
  recipe = "无人机平台2",
  x = 172,
  y = 165
  ...
  dir = "N",
  items = { { "无人机平台II", 8 }, { "玻璃", 15 }, { "科研中心I", 15 }, { "钢齿轮", 0 } },
  prototype_name = "仓库I",
  x = 169,
  y = 165
}, {
  ...
  items = { { "空气", 200 }, { "氮气", 104 }, { "二氧化碳", 0 }, { "氦气", 0 } },
  prototype_name = "蒸馏厂I",
  recipe = "空气分离2",
  x = 114,
  y = 101
  ...
  items = { { "过滤器", 0 }, { "空气", 2400 }, { "净化气", 996 }, { "用过的过滤器", 0 } },
  prototype_name = "化工厂I",
  recipe = "净化气2",
  x = 164,
  y = 187
  ...
  items = { { "钢齿轮", 2 }, { "绝缘线", 0 }, { "润滑油", 12 }, { "电动机I", 2 }, { "电动机II", 0 } },
  prototype_name = "组装机I",
  recipe = "电动机2",
  x = 133,
  y = 167
  ...
  dir = "N",
  items = { { "铁棒", 0 }, { "管道1-X型", 6 }, { "石砖", 8 }, { "烟囱I", 0 } },
  prototype_name = "组装机I",
  recipe = "烟囱1",
  x = 143,
  y = 134
  ...
  dir = "N",
  items = { { "科研中心II", 2 }, { "组装机III", 2 }, { "蒸汽发电机II", 0 }, { "物理科技包", 0 } },
  prototype_name = "组装机I",
  recipe = "物理科技包1",
  x = 130,
  y = 120
  ...
  dir = "N",
  items = { { "电容I", 4 }, { "铝棒", 8 }, { "电动机II", 0 }, { "蒸汽发电机I", 1 }, { "蒸汽发电机II", 0 } },
  prototype_name = "组装机I",
  recipe = "蒸汽发电机2",
  x = 130,
  y = 117
  ...
  dir = "N",
  items = { { "玻璃", 5 }, { "玻璃", 5 }, { "玻璃", 5 }, { "玻璃", 5 } },
  prototype_name = "仓库I",
  x = 126,
  y = 158
}, {
  dir = "N",
  items = { { "液罐I", 0 }, { "玻璃", 4 }, { "组装机I", 0 }, { "化工厂I", 0 } },
  prototype_name = "组装机II",
  recipe = "化工厂1",
  x = 146,
  y = 118
  ...
  dir = "N",
  items = { { "钢板", 1 }, { "坩埚", 4 }, { "熔炼炉I", 2 }, { "熔炼炉II", 0 } },
  prototype_name = "组装机I",
  recipe = "熔炼炉2",
  x = 70,
  y = 110
  ...
  dir = "N",
  items = { { "无人机平台I", 15 }, { "无人机平台I", 15 }, { "铝丝", 0 }, { "电容I", 4 } },
  prototype_name = "仓库I",
  x = 170,
  y = 170
}, {
  ...
  dir = "N",
  items = { { "烟囱I", 2 }, { "液罐I", 0 }, { "熔炼炉I", 2 }, { "蒸馏厂I", 2 } },
  prototype_name = "组装机I",
  recipe = "蒸馏厂1",
  x = 81,
  y = 108
  ...
  dir = "N",
  items = { { "科研中心I", 0 }, { "蒸馏厂II", 2 }, { "化工厂I", 0 }, { "化工厂II", 0 } },
  prototype_name = "组装机II",
  recipe = "化工厂2",
  x = 149,
  y = 118
  ...
  dir = "N",
  items = { { "化工厂II", 1 }, { "科研中心I", 1 }, { "科研中心II", 2 } },
  prototype_name = "组装机II",
  recipe = "科研中心2",
  x = 149,
  y = 121
  ...
  dir = "N",
  items = { { "钢板", 3 }, { "铝板", 3 }, { "组装机I", 2 }, { "组装机II", 0 } },
  prototype_name = "组装机II",
  recipe = "组装机2",
  x = 140,
  y = 114
  ...
  dir = "N",
  items = { { "管道1-X型", 0 }, { "钢齿轮", 0 }, { "电动机I", 0 }, { "蒸汽发电机I", 0 } },
  prototype_name = "组装机I",
  recipe = "蒸汽发电机1",
  x = 185,
  y = 169
  ...
  dir = "N",
  items = { { "管道1-X型", 8 }, { "钢齿轮", 3 }, { "电动机I", 4 }, { "蒸汽发电机I", 0 } },
  prototype_name = "组装机I",
  recipe = "蒸汽发电机1",
  x = 130,
  y = 123
