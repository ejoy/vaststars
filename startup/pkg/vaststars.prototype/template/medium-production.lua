...
local entities = { {
  ...
  items = { { "二氧化碳", 62 }, { "氢气", 220 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 152
  ...
  dir = "N",
  items = { { "铝矿石", 10 }, { "碾碎铝矿石", 7 }, { "碾碎铁矿石", 1 }, { "沙子", 0 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 146
  ...
  items = { { "二氧化碳", 75 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  items = { { "二氧化碳", 23 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 169
  ...
  dir = "N",
  items = { { "铝矿石", 10 }, { "碾碎铝矿石", 8 }, { "碾碎铁矿石", 0 }, { "沙子", 0 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 150
  ...
  dir = "N",
  items = { { "电子科技包", 27 }, { "化学科技包", 30 }, { "物理科技包", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 135
}, {
  ...
  dir = "N",
  items = { { "玻璃", 16 }, { "铝棒", 16 }, { "无人机平台II", 3 }, { "科研中心I", 0 } },
  prototype_name = "组装机I",
  recipe = "科研中心1",
  x = 174,
  y = 168
  ...
  items = { { "二氧化碳", 24 }, { "氢气", 147 }, { "甲烷", 0 }, { "纯水", 0 } },
  ...
  items = { { "二氧化碳", 52 }, { "氢气", 157 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 63,
  y = 154
  ...
  dir = "N",
  items = { { "碾碎铁矿石", 13 }, { "石墨", 2 }, { "铁板", 0 }, { "碎石", 3 }, { "铁矿石", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "铁板2",
  x = 107,
  y = 134
  ...
  dir = "N",
  items = { { "混凝土", 7 }, { "橡胶", 15 }, { "化学科技包", 30 }, { "化学科技包", 30 } },
  prototype_name = "仓库I",
  x = 53,
  y = 127
}, {
  ...
  items = { { "空气", 200 }, { "氮气", 73 }, { "二氧化碳", 0 }, { "氦气", 0 } },
  prototype_name = "蒸馏厂I",
  recipe = "空气分离2",
  x = 114,
  y = 101
  ...
  dir = "N",
  items = { { "沙子", 3 }, { "沙子", 3 }, { "沙子", 4 }, { "沙子", 4 } },
  prototype_name = "仓库I",
  x = 115,
  y = 193
}, {
  dir = "N",
  items = { { "沙子", 4 }, { "沙子", 4 }, { "沙子", 4 }, { "沙子", 5 } },
  prototype_name = "仓库I",
  x = 115,
  y = 197
}, {
  ...
  items = { { "过滤器", 0 }, { "空气", 1382 }, { "净化气", 0 }, { "用过的过滤器", 0 } },
  prototype_name = "化工厂I",
  recipe = "净化气2",
  x = 160,
  y = 187
  ...
  dir = "N",
  items = { { "铁棒", 2 }, { "管道1-X型", 4 }, { "石砖", 1 }, { "烟囱I", 0 } },
  prototype_name = "组装机I",
  recipe = "烟囱1",
  x = 143,
  y = 134
  ...
  dir = "N",
  items = { { "铁板", 0 }, { "铁板", 0 }, { "碎石", 13 }, { "碎石", 14 } },
  prototype_name = "仓库I",
  x = 83,
  y = 115
}, {
  dir = "N",
  items = { { "铁板", 16 }, { "石砖", 6 }, { "熔炼炉I", 0 } },
  prototype_name = "组装机I",
  recipe = "熔炼炉1",
  x = 66,
  y = 110
  ...
  dir = "N",
  items = { { "钢板", 8 }, { "坩埚", 4 }, { "熔炼炉I", 2 }, { "熔炼炉II", 0 } },
  prototype_name = "组装机I",
  recipe = "熔炼炉2",
  x = 70,
  y = 110
  ...
  items = { { "硫酸", 24 }, { "沙子", 2 }, { "二氧化碳", 0 }, { "废水", 0 }, { "金红石", 0 } },
