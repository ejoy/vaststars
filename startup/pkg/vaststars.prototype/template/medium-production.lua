...
local entities = { {
  ...
  dir = "N",
  items = { { "地质科技包", 2 }, { "气候科技包", 3 }, { "机械科技包", 2 }, { "电子科技包", 3 }, { "化学科技包", 0 }, { "物理科技包", 0 } },
  prototype_name = "科研中心I",
  x = 125,
  y = 133
}, {
  dir = "N",
  items = { { "石砖", 30 }, { "铁棒", 30 }, { "机械科技包", 15 }, { "地质科技包", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 134
}, {
  ...
  items = { { "二氧化碳", 500 }, { "氢气", 403 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 152
  ...
  items = { { "地下卤水", 3000 }, { "沙子", 16 }, { "废水", 0 }, { "硅", 9 } },
  prototype_name = "浮选器I",
  recipe = "硅1",
  x = 122,
  y = 153
  ...
  items = { { "二氧化碳", 500 }, { "氢气", 20 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  items = { { "二氧化碳", 500 }, { "氢气", 4 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 169
  ...
  items = { { "碾碎铝矿石", 0 }, { "碱性溶液", 3000 }, { "氢氧化铝", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 145,
  y = 167
  ...
  items = { { "碳化铝", 0 }, { "纯水", 500 }, { "氢氧化铝", 0 }, { "甲烷", 0 } },
  prototype_name = "化工厂I",
  recipe = "氢氧化铝",
  x = 142,
  y = 172
  ...
  items = { { "碳化铝", 4 }, { "纯水", 177 }, { "氢氧化铝", 0 }, { "甲烷", 0 } },
  prototype_name = "化工厂I",
  recipe = "氢氧化铝",
  x = 157,
  y = 172
  ...
  dir = "N",
  items = { { "石墨", 2 }, { "氧化铝", 2 }, { "塑料", 2 }, { "铝板", 4 }, { "电容I", 0 }, { "铝棒", 0 }, { "钢齿轮", 8 } },
  prototype_name = "组装机I",
  recipe = "电容1",
  x = 169,
  y = 166
  ...
  items = { { "二氧化碳", 500 }, { "氢气", 51 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 156
  ...
  items = { { "电容I", 2 }, { "绝缘线", 4 }, { "润滑油", 67 }, { "电子科技包", 0 } },
  prototype_name = "组装机I",
  recipe = "电子科技包1",
  x = 128,
  y = 164
