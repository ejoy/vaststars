...
function dn_sys:init()
    DAYNIGHT.DAY.DIRECT_COLORS, DAYNIGHT.DAY.INDIRECT_COLORS = 
        read_colors_from_files{
            direct = "/pkg/mod.daynight/assets/light/day_direct.pngx",
            indirect = "/pkg/mod.daynight/assets/light/day_indirect.pngx",
            intensity = "/pkg/mod.daynight/assets/light/day_intensity.pngx",
        }
    ...
    DAYNIGHT.NIGHT.DIRECT_COLORS, DAYNIGHT.NIGHT.INDIRECT_COLORS = 
        read_colors_from_files{
            ...
            indirect = "/pkg/mod.daynight/assets/light/day_indirect.pngx",
            intensity = "/pkg/mod.daynight/assets/light/day_intensity.pngx",
            -- direct = "/pkg/mod.daynight/assets/light/night_direct.pngx",
            -- indirect = "/pkg/mod.daynight/assets/light/night_indirect.pngx",
            -- intensity = "/pkg/mod.daynight/assets/light/night_intensity.pngx",
        }
end
