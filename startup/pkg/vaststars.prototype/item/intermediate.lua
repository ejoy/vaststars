...
prototype "碎石" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/stackeditems/gravel.glb|mesh.prefab config:s,3,3",
...
prototype "铁矿石" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/stackeditems/iron-ore.glb|mesh.prefab config:s,3,3",
...
prototype "铝矿石" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/stackeditems/aluminium-ore.glb|mesh.prefab config:s,3,3",
