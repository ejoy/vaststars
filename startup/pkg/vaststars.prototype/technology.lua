...
local prototype = gameplay.register.prototype
  ...
  prototype "迫降火星" {
    ...
    sign_desc = {
      { desc = "初次进入火星", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "搜索废墟" {
    ...
    sign_desc = {
      { desc = "搜索机身残骸获取有用物资", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "放置电线杆" {
    ...
    tips_pic = {
      "ui/textures/task_tips_pic/task_place_pole1.texture",
      "ui/textures/task_tips_pic/task_place_pole2.texture",
    },
    guide_focus = {
      {
        prefab = "prefabs/selected-box-no-animation.prefab",
    ...
    sign_desc = {
      { desc = "从风力发电机到采矿机放置1根铁制电线杆构成电网", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "放置无人机仓库" {
    ...
    -- },
    sign_desc = {
      { desc = "放置1座无人机仓库I", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "放置科研中心" {
    ...
    -- },
    sign_desc = {
      { desc = "放置1座科研中心", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "放置组装机" {
    ...
    -- },
    sign_desc = {
      { desc = "放置2台组装机", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "生产石砖" {
    ...
    sign_desc = {
      { desc = "使用组装机生产8个石砖", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "通向铁矿" {
    ...
    count = 20,
    tips_pic = {
      "ui/textures/task_tips_pic/task_place_road1.texture",
      "ui/textures/task_tips_pic/task_place_road2.texture",
      "ui/textures/task_tips_pic/task_place_road3.texture",
    },
    -- guide_focus = {
    --   {
    --     prefab = "prefabs/selected-box-no-animation.prefab",
    ...
    -- },
    sign_desc = {
      { desc = "铺设道路从指挥中心到东边的铁矿", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "放置熔炼炉" {
    ...
    sign_desc = {
      { desc = "放置1台熔炼炉", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "生产铁板" {
    ...
    sign_desc = {
      { desc = "使用熔炼炉生产4块铁板", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "生产铁棒" {
    ...
    sign_desc = {
      { desc = "使用组装机生产10个铁棒", icon = "ui/textures/construct/industry.texture"},
    },
  }
  ...
  prototype "维修运输车辆" {
    ...
    sign_desc = {
      { desc = "使用组装机生产4辆运输车", icon = "ui/textures/construct/industry.texture"},
    },
  }
...
prototype "生产管道" {
  ...
  sign_desc = {
    { desc = "使用组装机生产10个管道", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "建造空气过滤器" {
  ...
  sign_desc = {
    { desc = "生产1个空气过滤器", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "生产气候科技包" {
  ...
  sign_desc = {
    { desc = "使用水电站生产1个气候科技包", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "收集空气" {
  ...
  sign_desc = {
    { desc = "用空气过滤器生产20000单位空气", icon = "ui/textures/construct/industry.texture",},
  },
}
...
prototype "排放1" {
  ...
  prototype "生产液罐" {
    ...
    sign_desc = {
      { desc = "使用组装机生产2座液罐", icon = "ui/textures/construct/industry.texture"},
    },
  }
...
prototype "放置太阳能板" {
  ...
  sign_desc = {
    { desc = "放置2块太阳能板进行发电", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "放置蒸馏厂" {
  ...
  sign_desc = {
    { desc = "放置1座蒸馏厂", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "生产二氧化碳" {
  ...
  sign_desc = {
    { desc = "蒸馏厂分离空气生产500个单位二氧化碳", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "放置化工厂" {
  ...
  sign_desc = {
    { desc = "放置1座化工厂", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "生产甲烷" {
  ...
  sign_desc = {
    { desc = "用化工厂生产1000个单位甲烷", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "生产乙烯" {
  ...
  sign_desc = {
    { desc = "用化工厂生产1000个单位乙烯", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "生产塑料" {
  ...
  sign_desc = {
    { desc = "用化工厂生产30个塑料", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "生产机械科技包" {
  ...
  sign_desc = {
    { desc = "用组装机生产3个机械科技包", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "大炼钢铁" {
  ...
  sign_desc = {
    { desc = "用熔炼炉生产20个钢板", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "打造钢齿轮" {
  ...
  sign_desc = {
    { desc = "用组装机生产30个钢齿轮", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "坩埚制造" {
  ...
  sign_desc = {
    { desc = "用组装机生产20个坩埚", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "硅板制造" {
  ...
  sign_desc = {
    { desc = "用组装机生产30个硅板", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "铝丝制造" {
  ...
  sign_desc = {
    { desc = "用组装机生产40个铝丝", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "科技大跃进" {
  ...
  sign_desc = {
    { desc = "用组装机生产3个科研中心", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "效能提升" {
  ...
  sign_desc = {
    { desc = "用组装机生产5个效能插件I", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "速度提升" {
  ...
  sign_desc = {
    { desc = "用组装机生产5个速度插件I", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "产能提升" {
  ...
  sign_desc = {
    { desc = "用组装机生产5个产能插件I", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "铺设太阳能板" {
  ...
  sign_desc = {
    { desc = "放置20个太阳能板I", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "硫酸生产" {
  ...
  sign_desc = {
    { desc = "用化工厂生产500个单位硫酸", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "氦气生产" {
  ...
  sign_desc = {
    { desc = "用化工厂生产500个单位氦气", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "电池制造" {
  ...
  sign_desc = {
    { desc = "用化工厂生产20个电池", icon = "ui/textures/construct/industry.texture"},
  },
}
...
prototype "钛板生产" {
  ...
  sign_desc = {
    { desc = "用浮选器生产30个钛板", icon = "ui/textures/construct/industry.texture"},
  },
}
