...
local entities = { {
  ...
  dir = "N",
  items = { { "铁矿石", 60 }, { "铝矿石", 60 }, { "碎石", 60 }, { "铁板", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 133
}, {
  ...
  dir = "N",
  items = { { "碎石", 2 }, { "碾碎铁矿石", 2 }, { "碾碎铝矿石", 2 }, { "沙子", 2 }, { "地质科技包", 3 }, { "铝矿石", 4 }, { "铁矿石", 4 } },
  prototype_name = "组装机I",
  recipe = "地质科技包2",
  x = 122,
  y = 130
  ...
  items = { { "空气", 899 }, { "地下卤水", 4000 }, { "气候科技包", 2 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 131
  ...
  dir = "N",
  items = { { "碾碎铝矿石", 49 }, { "碾碎铝矿石", 49 }, { "沙子", 22 }, { "沙子", 23 } },
  prototype_name = "仓库I",
  x = 121,
  y = 148
}, {
  ...
  items = { { "二氧化碳", 8 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  items = { { "二氧化碳", 0 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 169
  ...
  dir = "N",
  items = { { "铝矿石", 1 }, { "碾碎铝矿石", 0 }, { "碾碎铁矿石", 0 }, { "沙子", 0 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 150
  ...
  dir = "N",
  items = { { "氢氧化钠", 1 }, { "氢氧化钠", 1 }, { "氢氧化钠", 0 }, { "氢氧化钠", 0 } },
  prototype_name = "仓库I",
  x = 92,
  y = 176
}, {
  ...
  items = { { "碾碎铝矿石", 4 }, { "碱性溶液", 0 }, { "氢氧化铝", 1 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 145,
  y = 167
  ...
  items = { { "碾碎铝矿石", 8 }, { "碱性溶液", 0 }, { "氢氧化铝", 6 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 152,
  y = 167
  ...
  dir = "N",
  items = { { "石墨", 2 }, { "氧化铝", 2 }, { "塑料", 0 }, { "铝板", 4 }, { "电容I", 0 } },
  prototype_name = "组装机I",
  recipe = "电容1",
  x = 169,
  y = 166
  ...
  dir = "N",
  items = { { "玻璃", 16 }, { "铝棒", 16 }, { "无人机平台II", 2 }, { "科研中心I", 0 } },
  prototype_name = "组装机I",
  recipe = "科研中心1",
  x = 174,
  y = 168
  ...
  dir = "N",
  items = { { "铝棒", 4 }, { "钢齿轮", 8 }, { "无人机平台I", 0 }, { "无人机平台II", 0 } },
  prototype_name = "组装机I",
  recipe = "无人机平台2",
  x = 172,
  y = 165
  ...
  dir = "N",
  items = { { "无人机平台II", 0 }, { "玻璃", 15 }, { "科研中心I", 15 }, { "钢齿轮", 30 } },
  prototype_name = "仓库I",
  x = 169,
  y = 165
}, {
  ...
  dir = "N",
  items = { { "碾碎铁矿石", 16 }, { "石墨", 2 }, { "铁板", 0 }, { "碎石", 4 }, { "铁矿石", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "铁板2",
  x = 111,
  y = 134
  ...
  dir = "N",
  items = { { "碾碎铁矿石", 16 }, { "石墨", 2 }, { "铁板", 0 }, { "碎石", 3 }, { "铁矿石", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "铁板2",
  x = 107,
  y = 134
  ...
  items = { { "纯水", 12 }, { "碎石", 8 }, { "沙子", 4 }, { "钢板", 1 }, { "混凝土", 0 } },
  prototype_name = "浮选器I",
  recipe = "混凝土",
  x = 130,
  y = 148
  ...
  items = { { "纯水", 12 }, { "碎石", 8 }, { "沙子", 4 }, { "钢板", 4 }, { "混凝土", 0 } },
  prototype_name = "浮选器I",
  recipe = "混凝土",
  x = 130,
  y = 152
  ...
  items = { { "橡胶", 10 }, { "硫酸", 5 }, { "混凝土", 0 }, { "氨气", 0 }, { "化学科技包", 0 } },
  prototype_name = "化工厂I",
  recipe = "化学科技包1",
  x = 50,
  y = 126
  ...
  items = { { "橡胶", 10 }, { "硫酸", 0 }, { "混凝土", 5 }, { "氨气", 0 }, { "化学科技包", 0 } },
  prototype_name = "化工厂I",
  recipe = "化学科技包1",
  x = 54,
  y = 126
  ...
  dir = "N",
  items = { { "混凝土", 0 }, { "橡胶", 15 }, { "化学科技包", 29 }, { "化学科技包", 29 } },
  prototype_name = "仓库I",
  x = 53,
  y = 127
}, {
  ...
  items = { { "硫酸", 0 }, { "铝板", 6 }, { "石墨", 4 }, { "钠", 4 }, { "电池I", 2 } },
  prototype_name = "化工厂I",
  recipe = "电池1",
  x = 46,
  y = 126
  ...
  items = { { "氯气", 39 }, { "石墨", 14 }, { "金红石", 3 }, { "四氯化钛", 0 }, { "废料", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "四氯化钛",
  x = 99,
  y = 133
  ...
  items = { { "氯气", 35 }, { "石墨", 14 }, { "金红石", 0 }, { "四氯化钛", 0 }, { "废料", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "四氯化钛",
  x = 99,
  y = 140
  ...
  items = { { "氦气", 2 }, { "钠", 2 }, { "四氯化钛", 0 }, { "钛板", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "钛板",
  x = 103,
  y = 115
  ...
  items = { { "氦气", 2 }, { "钠", 4 }, { "四氯化钛", 0 }, { "钛板", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "钛板",
  x = 109,
  y = 115
  ...
  dir = "N",
  items = { { "沙子", 2 }, { "沙子", 2 }, { "沙子", 2 }, { "沙子", 2 } },
  prototype_name = "仓库I",
  x = 115,
  y = 193
}, {
  dir = "N",
  items = { { "沙子", 2 }, { "沙子", 3 }, { "沙子", 3 }, { "沙子", 3 } },
  prototype_name = "仓库I",
  x = 115,
  y = 197
}, {
  ...
  items = { { "过滤器", 0 }, { "空气", 4 }, { "净化气", 0 }, { "用过的过滤器", 0 } },
  prototype_name = "化工厂I",
  recipe = "净化气2",
  x = 156,
  y = 187
  ...
  items = { { "过滤器", 0 }, { "空气", 401 }, { "净化气", 0 }, { "用过的过滤器", 0 } },
  prototype_name = "化工厂I",
  recipe = "净化气2",
  x = 160,
  y = 187
  ...
  items = { { "钢齿轮", 2 }, { "绝缘线", 6 }, { "润滑油", 2 }, { "电动机I", 2 }, { "电动机II", 2 } },
  prototype_name = "组装机I",
  recipe = "电动机2",
  x = 127,
  y = 167
  ...
  dir = "N",
  items = { { "玻璃", 9 }, { "玻璃", 9 }, { "玻璃", 8 }, { "玻璃", 8 } },
  prototype_name = "仓库I",
  x = 126,
  y = 158
}, {
  dir = "N",
  items = { { "液罐I", 4 }, { "玻璃", 8 }, { "组装机I", 0 }, { "化工厂I", 0 } },
  prototype_name = "组装机II",
  recipe = "化工厂1",
  x = 146,
  y = 118
  ...
  dir = "N",
  items = { { "碾碎铁矿石", 1 }, { "石墨", 2 }, { "铁板", 8 }, { "碎石", 1 }, { "铁矿石", 0 } },
  prototype_name = "熔炼炉II",
  recipe = "铁板2",
  x = 79,
  y = 119
  ...
  dir = "N",
  items = { { "碾碎铁矿石", 5 }, { "石墨", 2 }, { "铁板", 6 }, { "碎石", 2 }, { "铁矿石", 0 } },
  prototype_name = "熔炼炉II",
  recipe = "铁板2",
  x = 89,
  y = 119
  ...
  dir = "N",
  items = { { "钢板", 7 }, { "坩埚", 4 }, { "熔炼炉I", 2 }, { "熔炼炉II", 0 } },
  prototype_name = "组装机I",
  recipe = "熔炼炉2",
  x = 70,
  y = 110
  ...
  dir = "N",
  items = { { "无人机平台I", 0 }, { "无人机平台I", 0 }, { "铝丝", 30 }, { "电容I", 0 } },
  prototype_name = "仓库I",
  x = 170,
  y = 170
}, {
  ...
  dir = "N",
  items = { { "科研中心I", 2 }, { "蒸馏厂II", 2 }, { "化工厂I", 0 }, { "化工厂II", 0 } },
  prototype_name = "组装机II",
  recipe = "化工厂2",
  x = 149,
  y = 118
  ...
  dir = "N",
  items = { { "化工厂II", 1 }, { "科研中心I", 2 }, { "科研中心II", 2 } },
  prototype_name = "组装机II",
  recipe = "科研中心2",
  x = 149,
  y = 121
  ...
  dir = "N",
  items = { { "钢板", 8 }, { "铝板", 8 }, { "组装机I", 0 }, { "组装机II", 0 } },
  prototype_name = "组装机II",
  recipe = "组装机2",
  x = 140,
  y = 114
  ...
  dir = "N",
  items = { { "钛板", 12 }, { "无人机平台II", 2 }, { "组装机II", 0 }, { "组装机III", 0 } },
  prototype_name = "组装机II",
  recipe = "组装机3",
  x = 143,
  y = 114
  ...
  dir = "N",
  items = { { "科研中心II", 2 }, { "组装机III", 1 }, { "蒸汽发电机II", 2 }, { "物理科技包", 12 } },
  ...
  dir = "N",
  items = { { "科研中心II", 2 }, { "组装机III", 1 }, { "蒸汽发电机II", 2 }, { "物理科技包", 13 } },
  prototype_name = "组装机III",
  recipe = "物理科技包1",
  x = 127,
  y = 117
  ...
  dir = "N",
  items = { { "地质科技包", 3 }, { "气候科技包", 3 }, { "机械科技包", 1 }, { "电子科技包", 3 }, { "化学科技包", 3 }, { "物理科技包", 3 } },
  ...
  items = { { "硫酸", 0 }, { "沙子", 6 }, { "二氧化碳", 0 }, { "废水", 0 }, { "金红石", 0 } },
