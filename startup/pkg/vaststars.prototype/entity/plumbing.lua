...
prototype "液罐I" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/storage-tank-1.glb|mesh.prefab config:s,3,3",
...
prototype "地下水挖掘机I" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/mars-pumpjack.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "normal",
...
prototype "压力泵I" {
    ...
    model_status = {work = true, low_power = true},
    icon = "mem:/pkg/vaststars.resources/glbs/pump-1.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "normal",
...
prototype "烟囱I" {
    ...
    model_status = {work = true, low_power = true},
    icon = "mem:/pkg/vaststars.resources/glbs/chimney-1.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "normal",
...
prototype "排水口I" {
    ...
    model_status = {work = true, low_power = true},
    icon = "mem:/pkg/vaststars.resources/glbs/mars-outfall.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "normal",
    type = {"building", "fluidbox", "chimney", "auto_set_recipe"},
    area = "3x3",
...
prototype "空气过滤器I" {
    ...
    model_status = {work = true, low_power = true},
    icon = "mem:/pkg/vaststars.resources/glbs/air-filter.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "normal",
    type = {"building", "consumer", "assembling", "fluidboxes"},
    area = "2x2",
...
prototype "管道1-I型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/pipe/I.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "pipe",
...
prototype "管道1-L型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/pipe/L.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "pipe",
...
prototype "管道1-T型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/pipe/T.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "pipe",
    building_direction = {"N", "E", "S", "W"},
    type = {"building","fluidbox","pipe"},
...
prototype "管道1-X型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/pipe/X.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "pipe",
...
prototype "管道1-O型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/pipe/O.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "pipe",
    building_direction = {"N"},
    type = {"building","fluidbox","pipe"},
...
prototype "管道1-U型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/pipe/U.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "pipe",
    building_direction = {"N", "E", "S", "W"},
    type = {"building","fluidbox","pipe"},
...
prototype "地下管1-JU型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/pipe/JU.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
...
prototype "地下管1-JI型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/pipe/JI.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "pipe_to_ground",
    building_direction = {"N", "E", "S", "W"},
    type = {"building","fluidbox","pipe_to_ground"},
