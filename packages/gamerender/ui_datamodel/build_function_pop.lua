...
function M:create(object_id, left, top)
    if current_object_id and current_object_id ~= object_id then
        ...
        vsobject:send("modifier", "start", vsobject.game_object.game_object.srt_modifier, "over", true)
    end
    if current_object_id ~= object_id then
        local vsobject = vsobject_manager:get(object_id)
        vsobject:send("modifier", "start", vsobject.game_object.game_object.srt_modifier, "talk", true)
    end
