...
prototype "液罐I" {
    ...
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_gas_tank.texture",
...
prototype "气罐I" {
    model = "glbs/storage-tank-1.glb|mesh.prefab",
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_tank.texture",
    construct_detector = {"exclusive"},
    storage_tank = true,
    building_menu = true,
    type = {"building", "fluidbox"},
...
prototype "地下水挖掘机I" {
    ...
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_pumpjack.texture",
    construct_detector = {"exclusive"},
...
prototype "压力泵I" {
    ...
    model_status = {work = true, low_power = true},
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_pump.texture",
    construct_detector = {"exclusive"},
...
prototype "烟囱I" {
    ...
    model_status = {work = true, low_power = true},
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_chimney.texture",
    construct_detector = {"exclusive"},
...
prototype "排水口I" {
    ...
    model_status = {work = true, low_power = true},
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_mars_outfall.texture",
    construct_detector = {"exclusive"},
    type = {"building", "fluidbox", "chimney", "auto_set_recipe"},
    area = "3x3",
    rotate_on_build = true,
...
prototype "空气过滤器I" {
    ...
    model_status = {work = true, low_power = true},
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_air_filter.texture",
    construct_detector = {"exclusive"},
    type = {"building", "consumer", "assembling", "fluidboxes"},
    area = "2x2",
    rotate_on_build = true,
...
prototype "管道1-I型" {
    ...
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_pipe.texture",
    construct_detector = {"exclusive"},
...
prototype "地下管1-JU型" {
    ...
    icon = "/pkg/vaststars.resources/ui/textures/building-pic/small_pic_underground_pipe.texture",
    construct_detector = {"exclusive"},
    building_menu = false,
    building_direction = {"N", "E", "S", "W"},
