...
local entities = { {
  ...
  dir = "N",
  items = { { "铁矿石", 60 }, { "铝矿石", 60 }, { "碎石", 0 }, { "铁板", 26 } },
  prototype_name = "仓库I",
  x = 121,
  y = 133
}, {
  ...
  dir = "N",
  items = { { "碾碎铁矿石", 3 }, { "石墨", 2 }, { "铁板", 0 }, { "碎石", 0 }, { "铁矿石", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "铁板2",
  x = 115,
  y = 130
  ...
  dir = "N",
  items = { { "石砖", 11 }, { "机械科技包", 30 }, { "地质科技包", 30 }, { "铁棒", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 134
}, {
  ...
  items = { { "二氧化碳", 80 }, { "氢气", 14 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  items = { { "二氧化碳", 80 }, { "氢气", 10 }, { "一氧化碳", 26 }, { "纯水", 8 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 169
  ...
  items = { { "碾碎铝矿石", 6 }, { "碱性溶液", 7 }, { "氢氧化铝", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 145,
  y = 167
  ...
  items = { { "碾碎铝矿石", 8 }, { "碱性溶液", 16 }, { "氢氧化铝", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 152,
  y = 167
  ...
  items = { { "二氧化碳", 64 }, { "氢气", 214 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 156
  ...
  items = { { "地下卤水", 90 }, { "氧气", 0 }, { "氢气", 117 }, { "氯气", 0 } },
  prototype_name = "电解厂I",
  recipe = "地下卤水电解1",
  x = 73,
  y = 137
  ...
  dir = "N",
  items = { { "玻璃", 4 }, { "铝棒", 16 }, { "无人机平台II", 8 }, { "科研中心I", 0 } },
  prototype_name = "组装机I",
  recipe = "科研中心1",
  x = 174,
  y = 168
  ...
  dir = "N",
  items = { { "铝棒", 4 }, { "钢齿轮", 1 }, { "无人机平台I", 2 }, { "无人机平台II", 2 } },
  prototype_name = "组装机I",
  recipe = "无人机平台2",
  x = 172,
  y = 165
  ...
  dir = "N",
  items = { { "无人机平台II", 15 }, { "玻璃", 0 }, { "科研中心I", 15 }, { "钢齿轮", 0 } },
  prototype_name = "仓库I",
  x = 169,
  y = 165
}, {
  ...
  items = { { "二氧化碳", 64 }, { "氢气", 220 }, { "甲烷", 40 }, { "纯水", 0 } },
  ...
  items = { { "空气", 200 }, { "氮气", 84 }, { "二氧化碳", 0 }, { "氦气", 0 } },
  prototype_name = "蒸馏厂I",
  recipe = "空气分离2",
  x = 114,
  y = 101
  ...
  dir = "N",
  items = { { "铝矿石", 14 }, { "碾碎铝矿石", 8 }, { "碾碎铁矿石", 0 }, { "沙子", 0 }, { "碎石", 0 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 122,
  y = 149
  ...
  dir = "N",
  items = { { "铁棒", 3 }, { "管道1-X型", 5 }, { "石砖", 1 }, { "烟囱I", 0 }, { "液罐I", 0 } },
  prototype_name = "组装机I",
  recipe = "烟囱1",
  x = 143,
  y = 134
  ...
  dir = "N",
  items = { { "烟囱I", 2 }, { "液罐I", 0 }, { "熔炼炉I", 0 }, { "蒸馏厂I", 2 } },
  prototype_name = "组装机I",
  recipe = "蒸馏厂1",
  x = 81,
  y = 108
  ...
  dir = "N",
  items = { { "科研中心I", 0 }, { "蒸馏厂II", 2 }, { "化工厂I", 2 }, { "化工厂II", 0 } },
  prototype_name = "组装机II",
  recipe = "化工厂2",
  x = 149,
  y = 118
  ...
  dir = "N",
  items = { { "化工厂II", 0 }, { "科研中心I", 0 }, { "科研中心II", 0 } },
  prototype_name = "组装机II",
  recipe = "科研中心2",
  x = 149,
  y = 121
  ...
  dir = "N",
  items = { { "钛板", 0 }, { "无人机平台II", 2 }, { "组装机II", 2 }, { "组装机III", 1 } },
  prototype_name = "组装机II",
  recipe = "组装机3",
  x = 143,
  y = 114
