...
local entities = { {
  ...
  dir = "N",
  items = { { "铁矿石", 59 }, { "铝矿石", 60 }, { "碎石", 0 }, { "铁板", 25 } },
  prototype_name = "仓库I",
  x = 121,
  y = 133
}, {
  ...
  dir = "N",
  items = { { "碎石", 2 }, { "铁矿石", 3 }, { "铝矿石", 2 }, { "地质科技包", 0 } },
  prototype_name = "组装机I",
  recipe = "地质科技包1",
  x = 122,
  y = 130
  ...
  dir = "N",
  items = { { "地质科技包", 2 }, { "气候科技包", 1 }, { "机械科技包", 1 }, { "电子科技包", 1 }, { "化学科技包", 1 }, { "物理科技包", 2 } },
  prototype_name = "科研中心I",
  x = 125,
  y = 133
}, {
  dir = "N",
  items = { { "石砖", 30 }, { "机械科技包", 30 }, { "地质科技包", 27 }, { "铁棒", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 134
}, {
  ...
  items = { { "空气", 2999 }, { "地下卤水", 3039 }, { "气候科技包", 2 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 131
  ...
  items = { { "空气", 5499 }, { "地下卤水", 4000 }, { "气候科技包", 2 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 136
  ...
  items = { { "二氧化碳", 64 }, { "氢气", 192 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 152
  ...
  dir = "N",
  items = { { "铁齿轮", 28 }, { "铁齿轮", 28 }, { "电动机I", 15 }, { "采矿机I", 15 } },
  prototype_name = "仓库I",
  x = 121,
  y = 137
}, {
  ...
  dir = "N",
  items = { { "铝矿石", 7 }, { "碾碎铝矿石", 4 }, { "碾碎铁矿石", 1 }, { "沙子", 1 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 146
  ...
  dir = "S",
  items = { { "supply", "碾碎铝矿石", 2 }, { "demand", "铝矿石", 1 }, { "supply", "碾碎铁矿石", 2 }, { "demand", "沙子", 1 }, { "demand", "碎石", 2 } },
  prototype_name = "物流站",
  x = 120,
  y = 146
}, {
  dir = "N",
  items = { { "碾碎铝矿石", 0 }, { "碾碎铝矿石", 0 }, { "沙子", 60 }, { "沙子", 60 } },
  prototype_name = "仓库I",
  x = 121,
  y = 148
}, {
  ...
  items = { { "二氧化碳", 80 }, { "氢气", 3 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  items = { { "二氧化碳", 80 }, { "氢气", 26 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 169
  ...
  dir = "N",
  items = { { "铁矿石", 60 }, { "铁矿石", 60 }, { "石墨", 17 }, { "石墨", 16 } },
  prototype_name = "仓库I",
  x = 91,
  y = 170
}, {
  ...
  dir = "N",
  items = { { "铝矿石", 11 }, { "碾碎铝矿石", 0 }, { "碾碎铁矿石", 0 }, { "沙子", 1 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 150
  ...
  dir = "N",
  items = { { "硅板", 30 }, { "硅板", 30 }, { "石墨", 30 }, { "逻辑电路", 14 } },
  prototype_name = "仓库I",
  x = 124,
  y = 166
}, {
  ...
  dir = "N",
  items = { { "demand", "玻璃", 1 }, { "demand", "钢板", 1 }, { "supply", "塑料", 4 }, { "supply", "无人机平台I", 2 } },
  prototype_name = "物流站",
  x = 120,
  y = 142
}, {
  ...
  dir = "S",
  items = { { "supply", "钠", 3 }, { "supply", "氢氧化钠", 2 } },
  prototype_name = "物流站",
  x = 94,
  y = 176
}, {
  ...
  items = { { "碾碎铝矿石", 3 }, { "碱性溶液", 60 }, { "氢氧化铝", 1 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 152,
  y = 167
  ...
  dir = "N",
  items = { { "石墨", 2 }, { "氧化铝", 2 }, { "塑料", 6 }, { "铝板", 4 }, { "电容I", 3 } },
  prototype_name = "组装机I",
  recipe = "电容1",
  x = 169,
  y = 166
  ...
  dir = "N",
  items = { { "氧化铝", 30 }, { "石墨", 30 }, { "塑料", 15 }, { "铝板", 21 } },
  prototype_name = "仓库I",
  x = 169,
  y = 170
}, {
  ...
  items = { { "二氧化碳", 64 }, { "氢气", 103 }, { "甲烷", 24 }, { "纯水", 10 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 156
  ...
  dir = "N",
  items = { { "电子科技包", 30 }, { "化学科技包", 30 }, { "物理科技包", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 135
}, {
  ...
  dir = "S",
  items = { { "demand", "铝矿石", 2 }, { "supply", "碾碎铝矿石", 1 }, { "demand", "沙子", 2 }, { "demand", "铁矿石", 2 }, { "demand", "碎石", 1 } },
  prototype_name = "物流站",
  x = 116,
  y = 146
}, {
  ...
  dir = "N",
  items = { { "电容I", 2 }, { "绝缘线", 4 }, { "逻辑电路", 1 }, { "电子科技包", 0 } },
  prototype_name = "组装机I",
  recipe = "电子科技包1",
  x = 130,
  y = 167
  ...
  items = { { "地下卤水", 90 }, { "氧气", 0 }, { "氢气", 118 }, { "氯气", 0 } },
  prototype_name = "电解厂I",
  recipe = "地下卤水电解1",
  x = 73,
  y = 137
  ...
  items = { { "铝丝", 5 }, { "硅板", 12 }, { "润滑油", 10 }, { "逻辑电路", 4 } },
  prototype_name = "组装机I",
  recipe = "逻辑电路1",
  x = 116,
  y = 164
  ...
  dir = "N",
  items = { { "玻璃", 16 }, { "铝棒", 16 }, { "无人机平台II", 8 }, { "科研中心I", 2 } },
  prototype_name = "组装机I",
  recipe = "科研中心1",
  x = 174,
  y = 168
  ...
  dir = "N",
  items = { { "无人机平台II", 15 }, { "玻璃", 15 }, { "科研中心I", 15 }, { "钢齿轮", 30 } },
  prototype_name = "仓库I",
  x = 169,
  y = 165
}, {
  ...
  dir = "S",
  items = { { "demand", "铁矿石", 3 }, { "demand", "碾碎铁矿石", 1 }, { "supply", "铁板", 3 } },
  prototype_name = "物流站",
  x = 106,
  y = 128
}, {
  ...
  items = { { "橡胶", 10 }, { "硫酸", 36 }, { "混凝土", 11 }, { "氨气", 100 }, { "化学科技包", 0 } },
  prototype_name = "化工厂I",
  recipe = "化学科技包1",
  x = 50,
  y = 126
  ...
  items = { { "橡胶", 10 }, { "硫酸", 36 }, { "混凝土", 8 }, { "氨气", 100 }, { "化学科技包", 0 } },
  prototype_name = "化工厂I",
  recipe = "化学科技包1",
  x = 54,
  y = 126
  ...
  dir = "N",
  items = { { "混凝土", 15 }, { "橡胶", 15 }, { "化学科技包", 28 }, { "化学科技包", 29 } },
  prototype_name = "仓库I",
  x = 53,
  y = 127
}, {
  ...
  dir = "W",
  items = { { "supply", "铁矿石", 2 }, { "demand", "碎石", 2 } },
  prototype_name = "物流站",
  x = 152,
  y = 102
}, {
  ...
  items = { { "硫酸", 24 }, { "沙子", 4 }, { "二氧化碳", 0 }, { "废水", 0 }, { "金红石", 0 } },
  prototype_name = "浮选器I",
  recipe = "金红石1",
  x = 40,
  y = 125
  ...
  items = { { "氯气", 160 }, { "石墨", 14 }, { "金红石", 3 }, { "四氯化钛", 0 }, { "废料", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "四氯化钛",
  x = 99,
  y = 140
  ...
  items = { { "氦气", 2 }, { "钠", 12 }, { "四氯化钛", 0 }, { "钛板", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "钛板",
  x = 103,
  y = 115
  ...
  items = { { "空气", 200 }, { "氮气", 31 }, { "二氧化碳", 0 }, { "氦气", 0 } },
  prototype_name = "蒸馏厂I",
  recipe = "空气分离2",
  x = 108,
  y = 101
  ...
  items = { { "空气", 200 }, { "氮气", 76 }, { "二氧化碳", 0 }, { "氦气", 0 } },
  prototype_name = "蒸馏厂I",
  recipe = "空气分离2",
  x = 114,
  y = 101
  ...
  dir = "S",
  items = { { "demand", "铁矿石", 2 }, { "demand", "碎石", 1 }, { "demand", "物理科技包", 1 } },
  prototype_name = "物流站",
  x = 124,
  y = 128
}, {
  dir = "S",
  items = { { "demand", "铝矿石", 4 }, { "supply", "碾碎铁矿石", 1 }, { "supply", "碾碎铝矿石", 3 } },
  prototype_name = "物流站",
  x = 128,
  y = 146
}, {
  ...
  items = { { "过滤器", 0 }, { "空气", 2214 }, { "净化气", 0 }, { "用过的过滤器", 0 } },
  prototype_name = "化工厂I",
  recipe = "净化气2",
  x = 156,
  y = 187
  ...
  items = { { "过滤器", 0 }, { "空气", 2400 }, { "净化气", 186 }, { "用过的过滤器", 0 } },
  prototype_name = "化工厂I",
  recipe = "净化气2",
  x = 160,
  y = 187
  ...
  dir = "N",
  items = { { "用过的过滤器", 1 }, { "用过的过滤器", 1 }, { "用过的过滤器", 1 }, { "用过的过滤器", 1 } },
  prototype_name = "仓库I",
  x = 157,
  y = 191
}, {
  ...
  dir = "N",
  items = { { "铁棒", 4 }, { "管道1-X型", 6 }, { "石砖", 8 }, { "烟囱I", 2 } },
  prototype_name = "组装机I",
  recipe = "烟囱1",
  x = 143,
  y = 134
  ...
  dir = "N",
  items = { { "科研中心II", 2 }, { "组装机III", 2 }, { "蒸汽发电机II", 2 }, { "物理科技包", 20 } },
  prototype_name = "组装机I",
  recipe = "物理科技包1",
  x = 130,
  y = 120
  ...
  dir = "N",
  items = { { "电容I", 4 }, { "铝棒", 8 }, { "电动机II", 4 }, { "蒸汽发电机I", 2 }, { "蒸汽发电机II", 2 } },
  prototype_name = "组装机I",
  recipe = "蒸汽发电机2",
  x = 130,
  y = 117
  ...
  dir = "N",
  items = { { "铁板", 0 }, { "铁板", 0 }, { "铁板", 0 }, { "碎石", 31 } },
  prototype_name = "仓库I",
  x = 85,
  y = 116
}, {
  dir = "W",
  items = { { "supply", "铁板", 6 }, { "supply", "碎石", 2 } },
  prototype_name = "物流站",
  x = 86,
  y = 110
}, {
  ...
  dir = "N",
  items = { { "无人机平台I", 15 }, { "无人机平台I", 15 }, { "铝丝", 30 }, { "电容I", 15 } },
  prototype_name = "仓库I",
  x = 170,
  y = 170
}, {
  ...
  dir = "N",
  items = { { "科研中心I", 2 }, { "蒸馏厂II", 2 }, { "化工厂I", 2 }, { "化工厂II", 2 } },
  prototype_name = "组装机II",
  recipe = "化工厂2",
  x = 149,
  y = 118
  ...
  dir = "N",
  items = { { "化工厂II", 2 }, { "科研中心I", 2 }, { "科研中心II", 2 } },
  prototype_name = "组装机II",
  recipe = "科研中心2",
  x = 149,
  y = 121
  ...
  dir = "N",
  items = { { "钛板", 0 }, { "无人机平台II", 2 }, { "组装机II", 2 }, { "组装机III", 2 } },
  prototype_name = "组装机II",
  recipe = "组装机3",
  x = 143,
  y = 114
