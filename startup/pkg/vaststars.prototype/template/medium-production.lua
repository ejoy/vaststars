...
local entities = { {
  ...
  dir = "N",
  items = { { "碎石", 2 }, { "铁矿石", 2 }, { "铝矿石", 2 }, { "地质科技包", 2 } },
  prototype_name = "组装机I",
  recipe = "地质科技包1",
  x = 122,
  y = 130
  ...
  dir = "N",
  items = { { "电动机I", 1 }, { "铁齿轮", 6 }, { "机械科技包", 2 }, { "石砖", 0 }, { "管道1-X型", 10 } },
  prototype_name = "组装机I",
  recipe = "机械科技包T1",
  x = 122,
  y = 135
  ...
  dir = "N",
  items = { { "地质科技包", 2 }, { "气候科技包", 1 }, { "机械科技包", 1 }, { "电子科技包", 1 }, { "化学科技包", 1 }, { "物理科技包", 0 } },
  ...
  dir = "N",
  items = { { "地质科技包", 1 }, { "气候科技包", 1 }, { "机械科技包", 1 }, { "电子科技包", 1 }, { "化学科技包", 1 }, { "物理科技包", 0 } },
  prototype_name = "科研中心I",
  x = 125,
  y = 130
}, {
  ...
  items = { { "空气", 3299 }, { "地下卤水", 2519 }, { "气候科技包", 2 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 131
  ...
  dir = "N",
  items = { { "铁齿轮", 28 }, { "铁齿轮", 29 }, { "电动机I", 15 }, { "采矿机I", 15 } },
  prototype_name = "仓库I",
  x = 121,
  y = 137
}, {
  ...
  dir = "N",
  items = { { "沙子", 4 }, { "沙子", 5 }, { "碾碎铝矿石", 59 }, { "碾碎铝矿石", 60 } },
  prototype_name = "仓库I",
  x = 121,
  y = 148
}, {
  ...
  items = { { "二氧化碳", 80 }, { "氢气", 18 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  items = { { "二氧化碳", 80 }, { "氢气", 25 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 169
  ...
  dir = "N",
  items = { { "铁矿石", 60 }, { "铁矿石", 60 }, { "石墨", 16 }, { "石墨", 16 } },
  prototype_name = "仓库I",
  x = 91,
  y = 170
}, {
  ...
  dir = "N",
  items = { { "铝矿石", 7 }, { "碾碎铝矿石", 10 }, { "碾碎铁矿石", 0 }, { "沙子", 0 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 150
  ...
  items = { { "碳化铝", 9 }, { "纯水", 120 }, { "氢氧化铝", 0 }, { "甲烷", 102 } },
  prototype_name = "化工厂I",
  recipe = "氢氧化铝",
  x = 142,
  y = 172
  ...
  items = { { "碳化铝", 8 }, { "纯水", 120 }, { "氢氧化铝", 3 }, { "甲烷", 152 } },
  prototype_name = "化工厂I",
  recipe = "氢氧化铝",
  x = 157,
  y = 172
  ...
  items = { { "铝丝", 6 }, { "硅板", 2 }, { "润滑油", 10 }, { "逻辑电路", 0 }, { "电子科技包", 0 }, { "电容I", 0 }, { "绝缘线", 0 } },
  prototype_name = "组装机I",
  recipe = "逻辑电路1",
  x = 128,
  y = 164
  ...
  dir = "S",
  items = { { "demand", "铝矿石", 2 }, { "supply", "碾碎铝矿石", 1 }, { "demand", "碎石", 3 }, { "supply", "沙子", 2 } },
  prototype_name = "物流站",
  x = 116,
  y = 146
}, {
  ...
  dir = "N",
  items = { { "电容I", 2 }, { "绝缘线", 4 }, { "逻辑电路", 0 }, { "电子科技包", 0 } },
  prototype_name = "组装机I",
  recipe = "电子科技包1",
  x = 128,
  y = 167
  ...
  items = { { "地下卤水", 90 }, { "氧气", 0 }, { "氢气", 128 }, { "氯气", 0 } },
  prototype_name = "电解厂I",
  recipe = "地下卤水电解1",
  x = 73,
  y = 137
  ...
  items = { { "铝丝", 6 }, { "硅板", 5 }, { "润滑油", 10 }, { "逻辑电路", 0 }, { "电容I", 0 } },
  prototype_name = "组装机I",
  recipe = "逻辑电路1",
  x = 116,
  y = 164
  ...
  items = { { "二氧化碳", 64 }, { "氢气", 220 }, { "甲烷", 46 }, { "纯水", 0 } },
  ...
  items = { { "地下卤水", 90 }, { "氧气", 90 }, { "氢气", 46 }, { "氯气", 0 } },
  prototype_name = "电解厂I",
  recipe = "地下卤水电解1",
  x = 73,
  y = 147
  ...
  dir = "S",
  items = { { "demand", "铁矿石", 3 }, { "demand", "碾碎铁矿石", 1 } },
  prototype_name = "物流站",
  x = 106,
  y = 128
}, {
  ...
  items = { { "纯水", 12 }, { "碎石", 8 }, { "沙子", 4 }, { "钢板", 10 }, { "混凝土", 7 } },
  prototype_name = "浮选器I",
  recipe = "混凝土",
  x = 130,
  y = 152
  ...
  items = { { "空气", 200 }, { "氮气", 23 }, { "二氧化碳", 0 }, { "氦气", 0 } },
  prototype_name = "蒸馏厂I",
  recipe = "空气分离2",
  x = 108,
  y = 101
