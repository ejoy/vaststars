...
local entities = { {
  ...
  dir = "N",
  items = { { "地质科技包", 2 }, { "气候科技包", 2 }, { "机械科技包", 2 }, { "电子科技包", 2 }, { "化学科技包", 2 }, { "物理科技包", 2 } },
  prototype_name = "科研中心I",
  x = 125,
  y = 133
}, {
  dir = "N",
  items = { { "石砖", 30 }, { "机械科技包", 5 }, { "地质科技包", 30 }, { "铁棒", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 134
}, {
  ...
  items = { { "空气", 1999 }, { "地下卤水", 4000 }, { "气候科技包", 2 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 131
  ...
  items = { { "空气", 1899 }, { "地下卤水", 4000 }, { "气候科技包", 2 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 136
  ...
  items = { { "二氧化碳", 18 }, { "氢气", 220 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 152
  ...
  dir = "N",
  items = { { "铁齿轮", 14 }, { "铁齿轮", 14 }, { "电动机I", 10 }, { "采矿机I", 15 } },
  prototype_name = "仓库I",
  x = 121,
  y = 137
}, {
  ...
  dir = "N",
  items = { { "铝矿石", 14 }, { "碾碎铝矿石", 9 }, { "碾碎铁矿石", 0 }, { "沙子", 0 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 146
  ...
  dir = "N",
  items = { { "碾碎铝矿石", 60 }, { "碾碎铝矿石", 60 }, { "沙子", 60 }, { "沙子", 60 } },
  prototype_name = "仓库I",
  x = 121,
  y = 148
}, {
  ...
  items = { { "二氧化碳", 36 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  dir = "N",
  items = { { "铁矿石", 56 }, { "铁矿石", 56 }, { "石墨", 10 }, { "石墨", 10 } },
  prototype_name = "仓库I",
  x = 91,
  y = 170
}, {
  ...
  dir = "N",
  items = { { "铝矿石", 14 }, { "碾碎铝矿石", 10 }, { "碾碎铁矿石", 0 }, { "沙子", 0 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 150
  ...
  dir = "N",
  items = { { "氢氧化钠", 0 }, { "氢氧化钠", 0 }, { "氢氧化钠", 1 }, { "氢氧化钠", 1 } },
  prototype_name = "仓库I",
  x = 92,
  y = 176
}, {
  ...
  items = { { "碾碎铝矿石", 8 }, { "碱性溶液", 0 }, { "氢氧化铝", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 145,
  y = 167
  ...
  items = { { "碳化铝", 1 }, { "纯水", 120 }, { "氢氧化铝", 0 }, { "甲烷", 0 } },
  prototype_name = "化工厂I",
  recipe = "氢氧化铝",
  x = 142,
  y = 172
  ...
  items = { { "碳化铝", 0 }, { "纯水", 111 }, { "氢氧化铝", 0 }, { "甲烷", 0 } },
  prototype_name = "化工厂I",
  recipe = "氢氧化铝",
  x = 157,
  y = 172
  ...
  dir = "N",
  items = { { "氧化铝", 30 }, { "石墨", 30 }, { "塑料", 15 }, { "铝板", 30 } },
  prototype_name = "仓库I",
  x = 169,
  y = 170
}, {
  ...
  items = { { "地下卤水", 90 }, { "氧气", 0 }, { "氢气", 147 }, { "氯气", 0 } },
  prototype_name = "电解厂I",
  recipe = "地下卤水电解1",
  x = 73,
  y = 137
  ...
  items = { { "二氧化碳", 23 }, { "氢气", 220 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 63,
  y = 154
  ...
  items = { { "地下卤水", 45 }, { "氧气", 45 }, { "氢气", 110 }, { "氯气", 14 } },
  prototype_name = "电解厂I",
  recipe = "地下卤水电解1",
  x = 73,
  y = 147
  ...
  dir = "S",
  items = { { "demand", "铁矿石", 3 }, { "demand", "碾碎铁矿石", 2 }, { "supply", "铁板", 3 } },
  prototype_name = "物流站",
  x = 106,
  y = 128
}, {
  ...
  dir = "N",
  items = { { "碾碎铁矿石", 2 }, { "石墨", 2 }, { "铁板", 0 }, { "碎石", 0 }, { "铁矿石", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "铁板2",
  x = 107,
  y = 134
  ...
  items = { { "纯水", 12 }, { "碎石", 8 }, { "沙子", 4 }, { "钢板", 2 }, { "混凝土", 0 } },
  prototype_name = "浮选器I",
  recipe = "混凝土",
  x = 130,
  y = 148
  ...
  items = { { "纯水", 12 }, { "碎石", 8 }, { "沙子", 4 }, { "钢板", 3 }, { "混凝土", 0 } },
  prototype_name = "浮选器I",
  recipe = "混凝土",
  x = 130,
  y = 152
  ...
  items = { { "橡胶", 10 }, { "硫酸", 5 }, { "混凝土", 4 }, { "氨气", 1 }, { "化学科技包", 0 } },
  prototype_name = "化工厂I",
  recipe = "化学科技包1",
  x = 50,
  y = 126
  ...
  items = { { "橡胶", 10 }, { "硫酸", 0 }, { "混凝土", 1 }, { "氨气", 0 }, { "化学科技包", 0 } },
  prototype_name = "化工厂I",
  recipe = "化学科技包1",
  x = 54,
  y = 126
  ...
  dir = "N",
  items = { { "混凝土", 0 }, { "橡胶", 15 }, { "化学科技包", 5 }, { "化学科技包", 6 } },
  prototype_name = "仓库I",
  x = 53,
  y = 127
}, {
  ...
  items = { { "硫酸", 0 }, { "沙子", 0 }, { "二氧化碳", 0 }, { "废水", 0 }, { "金红石", 0 } },
  prototype_name = "浮选器I",
  recipe = "金红石1",
  x = 40,
  y = 125
  ...
  items = { { "氯气", 158 }, { "石墨", 14 }, { "金红石", 0 }, { "四氯化钛", 0 }, { "废料", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "四氯化钛",
  x = 99,
  y = 133
  ...
  items = { { "氯气", 85 }, { "石墨", 14 }, { "金红石", 2 }, { "四氯化钛", 0 }, { "废料", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "四氯化钛",
  x = 99,
  y = 140
  ...
  items = { { "氦气", 2 }, { "钠", 0 }, { "四氯化钛", 0 }, { "钛板", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "钛板",
  x = 103,
  y = 115
  ...
  items = { { "过滤器", 0 }, { "空气", 235 }, { "净化气", 0 }, { "用过的过滤器", 0 } },
  prototype_name = "化工厂I",
  recipe = "净化气2",
  x = 156,
  y = 187
  ...
  items = { { "过滤器", 0 }, { "空气", 2390 }, { "净化气", 0 }, { "用过的过滤器", 0 } },
  prototype_name = "化工厂I",
  recipe = "净化气2",
  x = 160,
  y = 187
  ...
  dir = "N",
  items = { { "钛板", 12 }, { "无人机平台II", 2 }, { "组装机II", 2 }, { "组装机III", 2 } },
  prototype_name = "组装机II",
  recipe = "组装机3",
  x = 143,
  y = 114
