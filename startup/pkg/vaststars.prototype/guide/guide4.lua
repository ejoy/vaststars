local guide2 = {
	{
        ...
        narrative_end = {
            pop_chapter = {"/pkg/vaststars.resources/ui/chapter_pop.html", {main_text = "教学", sub_text = "液网搭建"}},
            task = {
                "管道接收",
            },
            guide_progress = 10,
...

    {
        name = "",
		narrative = {
            {"哔哩..恭喜你结束了{/g 液网教学}..哔哩..", "/pkg/vaststars.resources/ui/textures/guide/guide-6.texture"},
        },
        narrative_end = {
            pop_chapter = {"/pkg/vaststars.resources/ui/tutorial_end.html", {text = "流体教学结束"}},
            task = {
                "流体教学结束",
            },
            guide_progress = 10,
