...
prototype "指挥中心" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/headquater-1.glb|mesh.prefab config:s,3,3",
...
prototype "物流中心" {
    ...
    model_status = {work = true},
    icon = "mem:/pkg/vaststars.resources/glbs/factory-1.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "station",
    craft_category = {"基地制造"},
    item = "运输车辆I",
...
prototype "科研中心I" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/lab-1.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "normal",
    area = "3x3",
    power = "100kW",
...
prototype "砖石公路-I型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/road/I.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "road",
...
prototype "砖石公路-L型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/road/L.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "road",
...
prototype "砖石公路-T型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/road/T.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "road",
    building_direction = {"N", "E", "S", "W"},
    track = "T",
...
prototype "砖石公路-X型" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/road/X.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "road",
    building_direction = {"N"},
    track = "X",
...
prototype "物流站" {
    ...
    icon = "mem:/pkg/vaststars.resources/glbs/goods-station-1.glb|mesh.prefab config:s,3,3",
    check_coord = "exclusive",
    builder = "station",
