...
local entities = { {
  ...
  dir = "N",
  items = { { "地质科技包", 3 }, { "气候科技包", 3 }, { "机械科技包", 3 }, { "电子科技包", 3 }, { "化学科技包", 3 }, { "物理科技包", 0 } },
  ...
  items = { { "空气", 2199 }, { "地下卤水", 4000 }, { "气候科技包", 2 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 131
  ...
  items = { { "二氧化碳", 17 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  dir = "N",
  items = { { "铁矿石", 60 }, { "铁矿石", 60 }, { "石墨", 26 }, { "石墨", 26 } },
  prototype_name = "仓库I",
  x = 91,
  y = 170
}, {
  ...
  dir = "N",
  items = { { "氢氧化钠", 5 }, { "氢氧化钠", 5 }, { "氢氧化钠", 5 }, { "氢氧化钠", 4 } },
  prototype_name = "仓库I",
  x = 92,
  y = 178
}, {
  ...
  dir = "N",
  items = { { "石墨", 1 }, { "氧化铝", 1 }, { "塑料", 3 }, { "铝板", 2 }, { "电容I", 3 } },
  prototype_name = "组装机I",
  recipe = "电容1",
  x = 169,
  y = 166
  ...
  dir = "N",
  items = { { "氧化铝", 30 }, { "石墨", 29 }, { "塑料", 12 }, { "铝板", 30 } },
  prototype_name = "仓库I",
  x = 169,
  y = 170
}, {
  ...
  items = { { "二氧化碳", 11 }, { "氢气", 220 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 156
  ...
  items = { { "铝丝", 6 }, { "硅板", 4 }, { "润滑油", 0 }, { "逻辑电路", 0 }, { "电子科技包", 0 }, { "电容I", 0 }, { "绝缘线", 0 } },
  prototype_name = "组装机I",
  recipe = "逻辑电路1",
  x = 128,
  y = 164
  ...
  items = { { "铝丝", 6 }, { "硅板", 4 }, { "润滑油", 0 }, { "逻辑电路", 0 }, { "电容I", 0 } },
  prototype_name = "组装机I",
  recipe = "逻辑电路1",
  x = 116,
  y = 164
  ...
  items = { { "纯水", 0 }, { "碎石", 8 }, { "沙子", 4 }, { "钢板", 10 }, { "混凝土", 7 } },
  prototype_name = "浮选器I",
  recipe = "混凝土",
  x = 130,
  y = 148
  ...
  items = { { "纯水", 0 }, { "碎石", 8 }, { "沙子", 4 }, { "钢板", 10 }, { "混凝土", 10 } },
  prototype_name = "浮选器I",
  recipe = "混凝土",
  x = 130,
  y = 152
  ...
  items = { { "橡胶", 10 }, { "硫酸", 11 }, { "混凝土", 12 }, { "氨气", 3 }, { "化学科技包", 4 } },
  prototype_name = "化工厂I",
  recipe = "化学科技包1",
  x = 50,
  y = 126
  ...
  items = { { "橡胶", 10 }, { "硫酸", 0 }, { "混凝土", 12 }, { "氨气", 0 }, { "化学科技包", 4 } },
  prototype_name = "化工厂I",
  recipe = "化学科技包1",
  x = 54,
  y = 126
  ...
  items = { { "硫酸", 0 }, { "沙子", 10 }, { "二氧化碳", 0 }, { "废水", 0 }, { "金红石", 0 } },
  prototype_name = "浮选器I",
  recipe = "金红石1",
  x = 40,
  y = 125
  ...
  items = { { "氯气", 125 }, { "石墨", 14 }, { "金红石", 3 }, { "四氯化钛", 0 }, { "废料", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "四氯化钛",
  x = 99,
  y = 140
