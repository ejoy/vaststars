...
local function test(start, count)
    local buttons = {
        [1] = {
            icon = "textures/building-menu/pickup-item.texture",
            params = "-pickup-item",
        },
        [2] = {
            icon = "textures/building-menu/place-item.texture",
            params = "-place-item",
        },
        [3] = {
            icon = "textures/building-menu/teardown.texture",
            params = "-teardown",
        }, 
        [4] = {
            icon = "textures/building-menu/move.texture",
            params = "-move",
        },
        [5] = {
            icon = "textures/building-menu/clone.texture",
            params = "-clone",
        },
    }
...
return function(start)
    ...
    if start.show_start_laying then
        ...
        v.icon = "textures/common/road-mutiple-build.texture"
    ...
    if start.show_remove_one then
        local v = setmetatable({}, {__index = DEFAULT})
        v.params = {"remove_one"}
        v.icon = "textures/common/road-disconnect.texture"
        start.buttons[#start.buttons + 1] = v
    end
    ...
    if start.show_start_teardown then
        ...
        v.icon = "textures/common/road-mutiple-delete.texture"
        start.buttons[#start.buttons + 1] = v
    end
