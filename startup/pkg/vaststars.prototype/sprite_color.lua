...
CONSTRUCT_POWER_INVALID = {0.0, 0.78, 0.78, 0.66}      -- 建造底块 & 有导电功能的建筑(非法时)
CONSTRUCT_DRONE_DEPOT_SUPPLY_AREA_SELF_VALID = {0.77, 0.35, 0.7, 0.15}   -- 无人机物流范围(合法时) -- 自身
CONSTRUCT_DRONE_DEPOT_SUPPLY_AREA_SELF_INVALID = {0.77, 0.35, 0.7, 0.15} -- 无人机物流范围(非法时) -- 自身
CONSTRUCT_DRONE_DEPOT_SUPPLY_AREA_OTHER = {0.8, 0.8, 0.3, 0.1}        -- 无人机物流范围(其它无人机) 
