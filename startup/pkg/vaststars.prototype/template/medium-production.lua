...
local entities = { {
  ...
  dir = "N",
  items = { { "碎石", 4 }, { "铁矿石", 4 }, { "铝矿石", 4 }, { "地质科技包", 1 } },
  prototype_name = "组装机I",
  recipe = "地质科技包1",
  x = 122,
  y = 130
  ...
  dir = "N",
  items = { { "地质科技包", 2 }, { "气候科技包", 3 }, { "机械科技包", 3 }, { "电子科技包", 2 }, { "化学科技包", 2 }, { "物理科技包", 0 } },
  prototype_name = "科研中心I",
  x = 125,
  y = 133
}, {
  dir = "N",
  items = { { "石砖", 30 }, { "机械科技包", 11 }, { "地质科技包", 30 }, { "铁棒", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 134
}, {
  ...
  items = { { "空气", 2499 }, { "地下卤水", 4000 }, { "气候科技包", 1 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 131
  ...
  items = { { "空气", 2499 }, { "地下卤水", 4000 }, { "气候科技包", 0 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 136
  ...
  dir = "N",
  items = { { "沙子", 1 }, { "沙子", 1 }, { "碾碎铝矿石", 60 }, { "碾碎铝矿石", 60 } },
  prototype_name = "仓库I",
  x = 121,
  y = 148
}, {
  ...
  items = { { "二氧化碳", 80 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  items = { { "二氧化碳", 27 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 169
  ...
  dir = "N",
  items = { { "铁矿石", 59 }, { "铁矿石", 59 }, { "石墨", 27 }, { "石墨", 27 } },
  prototype_name = "仓库I",
  x = 91,
  y = 170
}, {
  ...
  items = { { "碾碎铝矿石", 6 }, { "碱性溶液", 24 }, { "氢氧化铝", 3 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 145,
  y = 167
  ...
  items = { { "碾碎铝矿石", 5 }, { "碱性溶液", 10 }, { "氢氧化铝", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 152,
  y = 167
  ...
  items = { { "地下卤水", 90 }, { "氧气", 0 }, { "氢气", 151 }, { "氯气", 0 } },
  prototype_name = "电解厂I",
  recipe = "地下卤水电解1",
  x = 73,
  y = 137
  ...
  items = { { "铝丝", 6 }, { "硅板", 12 }, { "润滑油", 10 }, { "逻辑电路", 4 } },
  prototype_name = "组装机I",
  recipe = "逻辑电路1",
  x = 116,
  y = 164
  ...
  dir = "N",
  items = { { "电容I", 0 }, { "铝丝", 0 }, { "塑料", 4 }, { "硅板", 4 }, { "运算电路", 0 } },
  prototype_name = "组装机I",
  recipe = "运算电路1",
  x = 172,
  y = 175
  ...
  dir = "N",
  items = { { "玻璃", 0 }, { "铝棒", 16 }, { "无人机平台II", 8 }, { "科研中心I", 0 } },
  prototype_name = "组装机I",
  recipe = "科研中心1",
  x = 174,
  y = 168
  ...
  dir = "N",
  items = { { "数据线", 6 }, { "逻辑电路", 2 }, { "运算电路", 0 }, { "产能插件I", 0 } },
  prototype_name = "组装机I",
  recipe = "产能插件1",
  x = 169,
  y = 175
  ...
  dir = "N",
  items = { { "无人机平台II", 15 }, { "玻璃", 0 }, { "科研中心I", 15 }, { "钢齿轮", 30 } },
  prototype_name = "仓库I",
  x = 169,
  y = 165
}, {
  ...
  items = { { "二氧化碳", 26 }, { "氢气", 173 }, { "甲烷", 0 }, { "纯水", 0 } },
  ...
  items = { { "二氧化碳", 54 }, { "氢气", 165 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 63,
  y = 154
  ...
  items = { { "纯水", 0 }, { "碎石", 8 }, { "沙子", 4 }, { "钢板", 10 }, { "混凝土", 9 } },
  prototype_name = "浮选器I",
  recipe = "混凝土",
  x = 130,
  y = 148
  ...
  items = { { "硫酸", 32 }, { "铝板", 0 }, { "石墨", 4 }, { "钠", 4 }, { "电池I", 0 } },
  prototype_name = "化工厂I",
  recipe = "电池1",
  x = 46,
  y = 126
  ...
  items = { { "空气", 200 }, { "氮气", 72 }, { "二氧化碳", 0 }, { "氦气", 0 } },
  prototype_name = "蒸馏厂I",
  recipe = "空气分离2",
  x = 114,
  y = 101
  ...
  dir = "S",
  items = { { "demand", "铁矿石", 2 }, { "demand", "碎石", 1 } },
  prototype_name = "物流站",
  x = 124,
  y = 128
}, {
  ...
  items = { { "钢齿轮", 0 }, { "绝缘线", 0 }, { "润滑油", 0 }, { "电动机I", 0 }, { "电动机II", 0 } },
  prototype_name = "组装机I",
  recipe = "电动机2",
  x = 193,
  y = 166
  ...
  dir = "N",
  items = { { "科研中心I", 0 }, { "蒸馏厂II", 0 }, { "化工厂I", 0 }, { "化工厂II", 0 } },
  prototype_name = "组装机I",
  recipe = "化工厂2",
  x = 199,
  y = 172
  ...
  dir = "N",
  items = { { "科研中心II", 0 }, { "组装机III", 0 }, { "蒸汽发电机II", 0 }, { "物理科技包", 0 } },
  prototype_name = "组装机I",
  recipe = "物理科技包1",
  x = 199,
  y = 169
  ...
  dir = "N",
  items = { { "电容I", 0 }, { "铝棒", 0 }, { "电动机II", 0 }, { "蒸汽发电机I", 0 }, { "蒸汽发电机II", 0 } },
  prototype_name = "组装机I",
  recipe = "蒸汽发电机2",
  x = 199,
  y = 166
  ...
  dir = "N",
  items = { { "玻璃", 0 }, { "玻璃", 0 }, { "玻璃", 0 }, { "玻璃", 0 } },
  prototype_name = "仓库I",
  x = 126,
  y = 158
}, {
  dir = "N",
  items = { { "液罐I", 4 }, { "玻璃", 0 }, { "组装机I", 2 }, { "化工厂I", 0 } },
  prototype_name = "组装机II",
  recipe = "化工厂1",
  x = 146,
  y = 118
  ...
  dir = "N",
  items = { { "钢板", 8 }, { "坩埚", 0 }, { "熔炼炉I", 2 }, { "熔炼炉II", 0 } },
  prototype_name = "组装机I",
  recipe = "熔炼炉2",
  x = 70,
  y = 110
  ...
  dir = "N",
  items = { { "化工厂II", 0 }, { "科研中心I", 2 }, { "科研中心II", 0 } },
  prototype_name = "组装机II",
  recipe = "科研中心2",
  x = 149,
  y = 121
  ...
  dir = "N",
  items = { { "钢板", 8 }, { "铝板", 0 }, { "组装机I", 2 }, { "组装机II", 0 } },
  prototype_name = "组装机II",
  recipe = "组装机2",
  x = 140,
  y = 114
  ...
  dir = "N",
  items = { { "钛板", 0 }, { "无人机平台II", 2 }, { "组装机II", 0 }, { "组装机III", 0 } },
  prototype_name = "组装机II",
  recipe = "组装机3",
  x = 143,
  y = 114
  ...
  dir = "E",
  items = { { "demand", "石砖", 2 }, { "demand", "铁齿轮", 2 } },
  prototype_name = "物流站",
  x = 156,
  y = 114
}, {
  dir = "N",
  items = { { "石砖", 4 }, { "铁齿轮", 4 }, { "电动机I", 2 } },
  prototype_name = "组装机II",
  recipe = "电动机1",
  x = 158,
  y = 117
