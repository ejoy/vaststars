...
local entities = { {
  ...
  dir = "N",
  items = { { "铁矿石", 60 }, { "铝矿石", 60 }, { "碎石", 58 }, { "铁板", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 133
}, {
  ...
  dir = "N",
  items = { { "碎石", 2 }, { "碾碎铁矿石", 1 }, { "碾碎铝矿石", 2 }, { "沙子", 2 }, { "地质科技包", 0 }, { "铝矿石", 4 }, { "铁矿石", 4 } },
  prototype_name = "组装机I",
  recipe = "地质科技包2",
  x = 122,
  y = 130
  ...
  dir = "N",
  items = { { "石砖", 30 }, { "机械科技包", 0 }, { "地质科技包", 11 }, { "铁棒", 30 } },
  prototype_name = "仓库I",
  x = 121,
  y = 134
}, {
  ...
  dir = "N",
  items = { { "管道1-X型", 60 }, { "地下管1-JI型", 1 }, { "液罐I", 1 }, { "气候科技包", 4 } },
  prototype_name = "仓库I",
  x = 125,
  y = 136
}, {
  ...
  items = { { "空气", 2099 }, { "地下卤水", 4000 }, { "气候科技包", 0 } },
  prototype_name = "水电站I",
  recipe = "气候科技包1",
  x = 129,
  y = 131
  ...
  items = { { "二氧化碳", 61 }, { "氢气", 220 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 152
  ...
  dir = "N",
  items = { { "铝矿石", 8 }, { "碾碎铝矿石", 5 }, { "碾碎铁矿石", 1 }, { "沙子", 1 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 146
  ...
  dir = "N",
  items = { { "碾碎铝矿石", 60 }, { "碾碎铝矿石", 60 }, { "沙子", 44 }, { "沙子", 43 } },
  prototype_name = "仓库I",
  x = 121,
  y = 148
}, {
  ...
  items = { { "二氧化碳", 73 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 165
  ...
  items = { { "二氧化碳", 12 }, { "氢气", 80 }, { "一氧化碳", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转一氧化碳",
  x = 76,
  y = 169
  ...
  dir = "N",
  items = { { "铝矿石", 11 }, { "碾碎铝矿石", 6 }, { "碾碎铁矿石", 1 }, { "沙子", 0 } },
  prototype_name = "粉碎机I",
  recipe = "碾碎铝矿石",
  x = 125,
  y = 150
  ...
  items = { { "碾碎铝矿石", 2 }, { "碱性溶液", 60 }, { "氢氧化铝", 3 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 145,
  y = 167
  ...
  items = { { "碾碎铝矿石", 0 }, { "碱性溶液", 56 }, { "氢氧化铝", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "铝矿石浮选",
  x = 152,
  y = 167
  ...
  items = { { "碳化铝", 5 }, { "纯水", 120 }, { "氢氧化铝", 0 }, { "甲烷", 0 } },
  prototype_name = "化工厂I",
  recipe = "氢氧化铝",
  x = 142,
  y = 172
  ...
  dir = "N",
  items = { { "石墨", 1 }, { "氧化铝", 1 }, { "塑料", 5 }, { "铝板", 2 }, { "电容I", 1 } },
  prototype_name = "组装机I",
  recipe = "电容1",
  x = 169,
  y = 166
  ...
  items = { { "二氧化碳", 10 }, { "氢气", 220 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 85,
  y = 156
  ...
  dir = "N",
  items = { { "电子科技包", 7 }, { "化学科技包", 30 }, { "物理科技包", 29 } },
  prototype_name = "仓库I",
  x = 121,
  y = 135
}, {
  ...
  dir = "N",
  items = { { "电容I", 1 }, { "绝缘线", 4 }, { "逻辑电路", 1 }, { "电子科技包", 0 } },
  prototype_name = "组装机I",
  recipe = "电子科技包1",
  x = 130,
  y = 167
  ...
  items = { { "地下卤水", 90 }, { "氧气", 0 }, { "氢气", 143 }, { "氯气", 0 } },
  prototype_name = "电解厂I",
  recipe = "地下卤水电解1",
  x = 73,
  y = 137
  ...
  items = { { "铝丝", 6 }, { "硅板", 12 }, { "润滑油", 10 }, { "逻辑电路", 3 } },
  prototype_name = "组装机I",
  recipe = "逻辑电路1",
  x = 116,
  y = 164
  ...
  dir = "N",
  items = { { "玻璃", 7 }, { "铝棒", 16 }, { "无人机平台II", 8 }, { "科研中心I", 0 } },
  prototype_name = "组装机I",
  recipe = "科研中心1",
  x = 174,
  y = 168
  ...
  dir = "N",
  items = { { "铝棒", 4 }, { "钢齿轮", 5 }, { "无人机平台I", 1 }, { "无人机平台II", 0 } },
  prototype_name = "组装机I",
  recipe = "无人机平台2",
  x = 172,
  y = 165
  ...
  dir = "N",
  items = { { "无人机平台II", 7 }, { "玻璃", 0 }, { "科研中心I", 15 }, { "钢齿轮", 0 } },
  prototype_name = "仓库I",
  x = 169,
  y = 165
}, {
  ...
  items = { { "二氧化碳", 14 }, { "氢气", 194 }, { "甲烷", 0 }, { "纯水", 0 } },
  ...
  items = { { "二氧化碳", 43 }, { "氢气", 136 }, { "甲烷", 0 }, { "纯水", 0 } },
  prototype_name = "化工厂I",
  recipe = "二氧化碳转甲烷",
  x = 63,
  y = 154
  ...
  dir = "N",
  items = { { "碾碎铁矿石", 5 }, { "石墨", 2 }, { "铁板", 0 }, { "碎石", 4 }, { "铁矿石", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "铁板2",
  x = 111,
  y = 134
  ...
  dir = "N",
  items = { { "碾碎铁矿石", 1 }, { "石墨", 2 }, { "铁板", 0 }, { "碎石", 4 }, { "铁矿石", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "铁板2",
  x = 107,
  y = 134
  ...
  items = { { "纯水", 12 }, { "碎石", 8 }, { "沙子", 4 }, { "钢板", 2 }, { "混凝土", 6 } },
  prototype_name = "浮选器I",
  recipe = "混凝土",
  x = 130,
  y = 148
  ...
  items = { { "纯水", 12 }, { "碎石", 8 }, { "沙子", 4 }, { "钢板", 3 }, { "混凝土", 10 } },
  prototype_name = "浮选器I",
  recipe = "混凝土",
  x = 130,
  y = 152
  ...
  items = { { "橡胶", 8 }, { "硫酸", 36 }, { "混凝土", 6 }, { "氨气", 100 }, { "化学科技包", 0 } },
  prototype_name = "化工厂I",
  recipe = "化学科技包1",
  x = 50,
  y = 126
  ...
  dir = "N",
  items = { { "混凝土", 0 }, { "橡胶", 0 }, { "化学科技包", 27 }, { "化学科技包", 26 } },
  prototype_name = "仓库I",
  x = 53,
  y = 127
}, {
  ...
  items = { { "氯气", 160 }, { "石墨", 14 }, { "金红石", 1 }, { "四氯化钛", 0 }, { "废料", 0 } },
  prototype_name = "熔炼炉I",
  recipe = "四氯化钛",
  x = 99,
  y = 133
  ...
  dir = "W",
  items = { { "demand", "石墨", 2 }, { "demand", "金红石", 2 }, { "supply", "废料", 2 }, { "demand", "铁矿石", 1 } },
  prototype_name = "物流站",
  x = 102,
  y = 136
}, {
  ...
  items = { { "氦气", 2 }, { "钠", 8 }, { "四氯化钛", 3 }, { "钛板", 0 }, { "废水", 0 } },
  prototype_name = "浮选器I",
  recipe = "钛板",
  x = 103,
  y = 115
  ...
  items = { { "空气", 200 }, { "氮气", 97 }, { "二氧化碳", 0 }, { "氦气", 0 } },
  prototype_name = "蒸馏厂I",
  recipe = "空气分离2",
  x = 114,
  y = 101
  ...
  items = { { "过滤器", 0 }, { "空气", 2081 }, { "净化气", 0 }, { "用过的过滤器", 0 } },
  prototype_name = "化工厂I",
  recipe = "净化气2",
  x = 156,
  y = 187
  ...
  items = { { "过滤器", 0 }, { "空气", 2400 }, { "净化气", 416 }, { "用过的过滤器", 0 } },
  prototype_name = "化工厂I",
  recipe = "净化气2",
  x = 164,
  y = 187
  ...
  dir = "N",
  items = { { "钢板", 2 }, { "坩埚", 4 }, { "熔炼炉I", 2 }, { "熔炼炉II", 0 } },
  prototype_name = "组装机I",
  recipe = "熔炼炉2",
  x = 70,
  y = 110
  ...
  dir = "N",
  items = { { "无人机平台I", 15 }, { "无人机平台I", 15 }, { "铝丝", 30 }, { "电容I", 14 } },
  prototype_name = "仓库I",
  x = 170,
  y = 170
}, {
  ...
  dir = "N",
  items = { { "烟囱I", 2 }, { "液罐I", 0 }, { "熔炼炉I", 2 }, { "蒸馏厂I", 0 } },
  prototype_name = "组装机I",
  recipe = "蒸馏厂1",
  x = 81,
  y = 108
  ...
  dir = "N",
  items = { { "科研中心II", 2 }, { "组装机III", 0 }, { "蒸汽发电机II", 2 }, { "物理科技包", 0 } },
  ...
  dir = "N",
  items = { { "地质科技包", 2 }, { "气候科技包", 2 }, { "机械科技包", 0 }, { "电子科技包", 2 }, { "化学科技包", 2 }, { "物理科技包", 2 } },
